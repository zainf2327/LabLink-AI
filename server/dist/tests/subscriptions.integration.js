...
async function runTests() {
    ...
    if (!createPlanData.success)
        throw new Error('Plan creation failed: ' + createPlanData.message);
    ...
    await Subscription.updateOne({ userId: patient._id, status: 'active' }, { 'planSnapshot.testDiscountPercent': 20 });
    ...
    if (!booking1Data.success)
        throw new Error('Failed to create booking 1: ' + booking1Data.message);
    ...
    if (!booking2Data.success)
        throw new Error('Failed to create booking 2: ' + booking2Data.message);
