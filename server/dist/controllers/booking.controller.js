...
export const getAllBookings = asyncHandler(async (req, res) => {
    ...
    const type = req.query.type; // 'home' | 'lab'
...
export const autoAssignBooking = asyncHandler(async (req, res) => {
...
export const autoAssignAllBookings = asyncHandler(async (req, res) => {
    ...
    const query = {
        ...
        status: { $in: ['scheduled', 'pending_manual_assignment'] }
    };
